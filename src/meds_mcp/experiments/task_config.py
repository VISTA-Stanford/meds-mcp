...
TASK_TO_FILENAME: Dict[str, str] = {
    "guo_readmission": "labels_readmission.csv",
    "new_celiac": "labels_celiac.csv",
    "guo_icu": "labels_icu.csv",
    "guo_los": "labels_los.csv",
    "new_lupus": "labels_lupus.csv",
    "new_mi": "labels_mi.csv",
    "new_pancan": "labels_pancan.csv",
    "lab_anemia": "labels_anemia.csv",
    "lab_hyperkalemia": "labels_hyperkalemia.csv",
    "lab_hyperlipidemia": "labels_hyperlipidemia.csv",
    "lab_hypertension": "labels_hypertension.csv",
    "lab_hypoglycemia": "labels_hypoglycemia.csv",
    "lab_hypoatremia": "labels_hypoatremia.csv",
    "lab_thrombocytopenia": "labels_thrombocytopenia.csv",
}
...
TASK_QUESTIONS: Dict[str, str] = {
    ...
    "lab_hypertension": "Based on this patient's clinical history to date, is it likely they will develop chronic high blood pressure within the next year?",
    "lab_hyperlipidemia": "Based on this patient's current health profile, is it likely they will be diagnosed with elevated cholesterol or lipid abnormalities within the next year?",
    ...
    "new_mi": "Based on this patient's cardiovascular risk profile and history, is it likely they will experience a heart attack within the next year?",
